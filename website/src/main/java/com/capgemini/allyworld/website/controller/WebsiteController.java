...
public class WebsiteController {
	...
	public ResponseEntity<String> userRegistration(@ModelAttribute Profile profile)
	{
		...
		ResponseEntity<Profile> updatedProfile = restTemplate.postForEntity("http://localhost:2013/profiles", profile, Profile.class);
	...
	public ModelAndView autheticateUser(@ModelAttribute Profile profile) {
		...
		ResponseEntity<Profile> response = restTemplate.postForEntity("http://localhost:2013/profiles/authenticate", profile, Profile.class);
	...
	public void viewingUserProfile() {
